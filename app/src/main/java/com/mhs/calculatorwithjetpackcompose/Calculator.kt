...
import com.mhs.calculatorwithjetpackcompose.ui.theme.LightGray
import com.mhs.calculatorwithjetpackcompose.ui.theme.Orange
        ...
        Column (
            ...
            Row (
                ...
                CalculatorButton(symbol = "-", modifier = Modifier
                    ...
                    .weight(1f),
                    onClick = {
                        onActions(CalculatorActions.Operation(CalculatorOperations.Subtraction))
                    }
                )
            }
